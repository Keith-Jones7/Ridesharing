...
//        sampleSUE.solveSUE();
    ...
    public void generateSample2() {
        ...
        String fileName = "size_rate.txt";
        double[] matchingSum = new double[100];
        double[] roadSum = new double[100];
        for (int i = 0; i < 100; i++) {
            sizeRate[2] += 0.005;
            sizeRate[0] -= 0.005;
        ...
        write(fileName, matchingSum, roadSum);
    }
    ...
    public void generateSample3() {
        ...
        String fileName = "matching_rate_driver.txt";
        ...
        write(fileName, matchingRatePassenger, costPassenger);
    }
